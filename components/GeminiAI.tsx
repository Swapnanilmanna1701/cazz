...
const GeminiAI: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between h-[calc(100vh-5rem)] sm:p-3 lg:px-52 overflow-y-hidden pissoff">
          ...
          <>
            <div className="flex flex-col justify-center items-center">
              ...
              <Image
                ...
                height={800}
                alt="Gemini AI"
                className="mt-5 hover:scale-100 scale-90 transition-all duration-500 ease-in-out robot sm:rounded-lg"
              />
            </div>
          </>
        ) : (
                ...
                >
                  ...
                  <div
                    className={`chat-bubble max-w-full ${message.type === "ai"
                      ? "bg-gradient-to-br from-sky-400 via-blue-400 to-indigo-600 text-white"
                      : "bg-gradient-to-br from-sky-400 via-blue-400 to-indigo-600 text-white"
                      }`}
                  >
      ...
      <div className="w-full flex flex-col items-start justify-center mt-5">
        <div className="w-full flex items-center bg-gradient-to-br from-sky-600 via-blue-800 to-indigo-900 bg-opacity-90 backdrop-blur-md sm:rounded-md px-4 py-2">
          <input
            type="text"
            value={inputValue}
