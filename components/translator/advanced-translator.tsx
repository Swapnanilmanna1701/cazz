...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-black dark:to-rose-900/20 flex flex-col transition-colors duration-200">
      <div className="flex-grow flex flex-col p-4 md:p-6 relative overflow-hidden">
        <div className="relative z-10 mx-auto w-full max-w-5xl space-y-6 flex flex-col flex-grow">
          ...
          <div className="flex gap-2 mt-4">
            <Button
              className="flex-1 bg-gradient-to-r from-pink-600  to-blue-500 text-white"
              size="lg"
