      ...
      <AnimationContainer delay={0.3}>
        <div className="mt-20 w-full">
          <div className="flex flex-col items-center justify-center w-full pt-12">
            <h2 className="mt-6 text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 font-semibold text-center lg:text-3xl xl:text-4xl">
          ...
          <div className="max-w-3xl text-blue-400 mx-auto w-full mt-20">
